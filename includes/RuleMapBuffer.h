...
class RuleMapBuffer : public Indicator
{
  public:
    ...
    static_assert(std::is_base_of<RuleMap<typename Target::Successor>, Target>::value,
                  "RuleMapBuffer must refer to a derived class of RuleMap");
    ...
    struct Rule
    {
        ...
        {
            return is_active == other.is_active && predecessor == other.predecessor
