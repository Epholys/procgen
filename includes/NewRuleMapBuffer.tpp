...
NewRuleMapBuffer<Target>::NewRuleMapBuffer(std::shared_ptr<Target> target)
...
template<typename Target>
NewRuleMapBuffer<Target>::NewRuleMapBuffer(const NewRuleMapBuffer& other)
...
template<typename Target>
NewRuleMapBuffer<Target>::NewRuleMapBuffer(const NewRuleMapBuffer& other, std::shared_ptr<Target> target)
    : Observer<Target>(target)
    , buffer_ {other.buffer_}
    , instruction_ {nullptr}
    , reverse_instruction_ {nullptr}
...
template<typename Target>
NewRuleMapBuffer<Target>::NewRuleMapBuffer(NewRuleMapBuffer&& other)
...
template<typename Target>
NewRuleMapBuffer<Target>& NewRuleMapBuffer<Target>::operator=(const NewRuleMapBuffer& other)
{
    if (this != &other)
    {
...
template<typename Target>
NewRuleMapBuffer<Target>& NewRuleMapBuffer<Target>::operator=(NewRuleMapBuffer&& other)
{
    if (this != &other)
    {
...
template<typename Target>
Target& NewRuleMapBuffer<Target>::observer_target() const
{
    return *(this->get_target());
}

template<typename Target>
typename NewRuleMapBuffer<Target>::const_iterator NewRuleMapBuffer<Target>::begin() const
{
    return buffer_.cbegin();
}

template<typename Target>
typename NewRuleMapBuffer<Target>::const_iterator NewRuleMapBuffer<Target>::end() const
{
    return buffer_.cend();
}

template<typename Target>
size_t NewRuleMapBuffer<Target>::size() const
{
    return buffer_.size();
}
...
template<typename Target>
typename NewRuleMapBuffer<Target>::iterator NewRuleMapBuffer<Target>::remove_const(const_iterator cit)
{
...
template<typename Target>
void NewRuleMapBuffer<Target>::add_rule()
{
    reverse_instruction_ = nullptr;
...
template<typename Target>
void NewRuleMapBuffer<Target>::erase(const_iterator cit)
{
...
template<typename Target>
void NewRuleMapBuffer<Target>::change_predecessor(const_iterator cit, char pred)
{    
    Expects(cit != buffer_.end());
    ...
    NewRuleMapBuffer<Target>::iterator it = remove_const(cit);
...
template<typename Target>
void NewRuleMapBuffer<Target>::remove_predecessor(NewRuleMapBuffer<Target>::const_iterator cit)
{
    Expects(cit != buffer_.end());
...
template<typename Target>
void NewRuleMapBuffer<Target>::change_successor(const_iterator cit, const succ& succ)
{
    Expects(cit != buffer_.end());
...
template <typename Target>
void NewRuleMapBuffer<Target>::remove_rule(char pred) {
    reverse_instruction_ = nullptr;
...
template<typename Target>
void NewRuleMapBuffer<Target>::delayed_add_rule()
{
    instruction_ = [=](){ add_rule(); };
}
template<typename Target>
void NewRuleMapBuffer<Target>::delayed_erase(const_iterator cit)
{
    instruction_ = [=](){ erase(cit); };
}
template<typename Target>
void NewRuleMapBuffer<Target>::delayed_change_predecessor(const_iterator cit, char pred)
{
    instruction_ = [=](){ change_predecessor(cit, pred); };
}
template<typename Target>
void NewRuleMapBuffer<Target>::delayed_remove_predecessor(const_iterator cit)
{
    instruction_ = [=](){ remove_predecessor(cit); };
}
template<typename Target>
void NewRuleMapBuffer<Target>::delayed_change_successor(const_iterator cit, const succ& succ)
{
    instruction_ = [=](){ change_successor(cit, succ); };
}

template<typename Target>
void NewRuleMapBuffer<Target>::apply()
{
    if(instruction_)
    {
        instruction_();
...
template<typename Target>
void NewRuleMapBuffer<Target>::revert()
{
...
template<typename Target>
void NewRuleMapBuffer<Target>::validate()
{
    reverse_instruction_ = nullptr;
}

template<typename Target>
void NewRuleMapBuffer<Target>::sync()
{
