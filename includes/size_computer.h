...
constexpr float bytes_per_vertex = sizeof(sf::Vertex) + sizeof(u8)
                                   + 1 / 8.; // Vertex + Iteration + transparent
...
system_size
    compute_max_size(const LSystem& lsystem, const drawing::InterpretationMap& map, int n_iter);
