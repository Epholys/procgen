...
** Development framework
   ...
   - *Dependencies:*
     ...
     - dear imgui, / 2018-11-23 / [[https://github.com/ocornut/imgui][Github Repository]] / cloned from the repository / included in the repo
     - imgui-sfml / 2018-11-23 / [[https://github.com/eliasdaler/imgui-sfml][Github Repository]] / installed via the instructions from the README.org of the repository / included in the repo
