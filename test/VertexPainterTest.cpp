...
{
    std::array<sf::Color, vertices.grid_size> colors {sf::Color::Red,
                                                      sf::Color::Blue,
                                                      sf::Color::Yellow,
                                                      sf::Color::Green};
    ColorGeneratorWrapper colors_gen(std::make_shared<DiscreteGradient>(
...
TEST(VertexPainter, Linear)
{
    ...
    std::vector<sf::Color> expected_colors = {sf::Color::Yellow,
                                              sf::Color::Yellow,
                                              sf::Color::Yellow,
                                              sf::Color::Yellow,
                                              sf::Color::Green,
...
TEST(VertexPainter, Radial)
{
    ...
    std::vector<sf::Color> expected_colors = {sf::Color::Blue,
                                              sf::Color::Blue,
                                              sf::Color::Blue,
                                              sf::Color::Green,
                                              sf::Color::Blue,
...
TEST(VertexPainter, Random)
{
    ...
    for (int i = 0; i < size; ++i)
    {
        ...
        ASSERT_TRUE(std::all_of(begin(grid_colors), end(grid_colors), [first](auto col) {
            return col == first;
        }));
        ASSERT_TRUE(
            std::any_of(begin(colors), end(colors), [first](auto col) { return col == first; }));
    }
}
...
TEST(VertexPainter, Composite)
{
    ...
    ColorGeneratorWrapper constant_gen(std::make_shared<ConstantColor>(color));
    ColorGeneratorWrapper discrete_gen1(std::make_shared<DiscreteGradient>(
        DiscreteGradient::keys({{colors1[0], 0}, {colors1[1], 1}})));
    ColorGeneratorWrapper discrete_gen2(std::make_shared<DiscreteGradient>(
        DiscreteGradient::keys({{colors2[0], 0}, {colors2[1], 1}})));
    ColorGeneratorWrapper discrete_gen3(std::make_shared<DiscreteGradient>(
    ...
    VertexPainterWrapper sequential_wrapper(
        std::make_shared<VertexPainterSequential>(discrete_gen3));

    std::vector<sf::Vertex> grid = vertices.grid;
    VertexPainterComposite composite;
    composite.set_main_painter(VertexPainterWrapper(std::make_shared<VertexPainterIteration>()));
    composite.set_child_painters(
        {constant_wrapper, radial_wrapper, linear_wrapper, sequential_wrapper});
    ...
    std::vector<sf::Color> expected_colors = {sf::Color::Red,
                                              sf::Color::Red,
                                              sf::Color::Red,
                                              sf::Color::Red,
                                              sf::Color::Blue,
...
{
    std::array<sf::Color, vertices.grid_size> colors1 {sf::Color::Red,
                                                       sf::Color::Blue,
                                                       sf::Color::Yellow,
                                                       sf::Color::Green};
    ColorGeneratorWrapper colors_gen1(std::make_shared<DiscreteGradient>(DiscreteGradient::keys(
        {{colors1[0], 0}, {colors1[1], 1}, {colors1[2], 2}, {colors1[3], 3}})));
    auto orandom = std::make_shared<VertexPainterRandom>(colors_gen1);
    orandom->set_block_size(vertices.grid_size);

    ColorGeneratorWrapper colors2(std::make_shared<ConstantColor>(sf::Color::Red));
    auto oconstant = std::make_shared<VertexPainterConstant>(colors2);

    std::array<sf::Color, vertices.grid_size> colors3 {sf::Color::Red,
                                                       sf::Color::Blue,
                                                       sf::Color::Green};
    ColorGeneratorWrapper colors_gen3(std::make_shared<DiscreteGradient>(
