...
int main(int argc, char* argv[])
{
    ...
    bool open_default_lsystem = false;
    ...
    if (argc == 2)
    {
        ...
        else
        {
            ...
            archive(loaded_view);
            loaded_view.ref_parameters().set_starting_position({window::window_size.x / 4, window::window_size.y / 3});
            views.push_back(std::move(loaded_view));
        }
    }
    else
    {
